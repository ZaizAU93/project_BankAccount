...
а также конечную точку временного интервала. Результат 
отобразиться в консоли.
...
(CREATE TABLE IF NOT EXISTS `root`.`operations` (
  `id` INT AUTO_INCREMENT,   `data` VARCHAR(1000) NULL, `operations` varchar(1000) NULL,
  PRIMARY KEY (`id`)
)ENGINE = InnoDB)
(CREATE TABLE `banckaccount` (
  `id` int NOT NULL AUTO_INCREMENT,
  `checkB` varchar(200) DEFAULT NULL,
